# Generated by Django 2.2.2 on 2019-07-08 13:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('route_id', models.ForeignKey(db_column='route_id', on_delete=django.db.models.deletion.CASCADE, to='map.Routes', verbose_name='Route ID')),
